...
@section('content')
    ...
    <div class="card">
        <div class="card-block">
            <div class="m-b-1">
                <h6>Generar reporte por obras</h6>
                <hr/>
            </div>
            <div class="row">
    ...
    @if(empty($informacion_consolidado)== false)
        ...
        <div class="card">
            <div class="card-block">
                <div class="m-b-1">
                    <h6>Información por obra, producto y dia calendario</h6>
                    <hr/>
                </div>
                <div class="row">
                    <div class="col-md-12">
    ...
    @if(empty($informacion_consolidado)== false)
        ...
        <script>
            ...
            Highcharts.chart('container1', {
                ...
                title: {
                    text: 'Porductos graficado por dias calendario'
                },
                subtitle: {
                ...
                yAxis: {
                    title: {
                        text: 'Cantidad unidades enviadas'
                    },
                    min: 0
                },
                tooltip: {
                ...
                <?php
                    ...
                    $data = '';
                    foreach ($informacion_por_dias as $row) {
                        if ($codigo_prod != $row->nombre_obra && $codigo_prod == '') {
                            $data .= "name: '" . $row->nombre_obra . "' , data: [ ";
                            $codigo_prod = $row->nombre_obra;
                        } else if ($codigo_prod != $row->nombre_obra && $codigo_prod != '') {
                            $codigo_prod = $row->nombre_obra;
                            $data .= "]}, {name: '" . $row->nombre_obra . "' , data: [ ";
                        }
            ...
            Highcharts.chart('container2', {
                ...
                title: {
                    text: 'Grafica consolidado cantidades por obras'
                },
                tooltip: {
